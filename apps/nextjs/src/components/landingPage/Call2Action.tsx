        ...
        <div className="relative overflow-hidden">
          <div className="-mx-4 flex flex-wrap items-stretch">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[570px] text-center lg:max-w-[700px]">
                ...
                <p className="mx-auto mb-6 max-w-[515px] text-wrap text-base leading-[1.5] text-white lg:max-w-none lg:text-xl">
                  ...
                  AI. Trace your resources from farm to fork, easily generate
                  reports for stakeholders, and provide transparency to your
                  clients.
                </p>
                <Link href="https://cal.com/brightonmboya/15min">
                  <p className="bg-secondary inline-block rounded-md border border-transparent px-7 py-3 text-base font-medium text-white transition">
