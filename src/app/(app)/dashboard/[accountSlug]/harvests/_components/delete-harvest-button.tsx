...
export default function DeleteFarmerButton({ farmerId }: { farmerId: string }) {
  ...
  const { mutateAsync, isPending } = api.harvests.delete.useMutation({
    onSuccess: () => {
      toast({
        title: "Success",
        description: "Succesfully deleted the harvest record",
        duration: 5000,
      });
    },
    onSettled: () => {
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            By deleting this harvest record, you wont be able to undo this
            action Please type <strong>delete</strong> to confirm.
          </AlertDialogDescription>
        </AlertDialogHeader>
