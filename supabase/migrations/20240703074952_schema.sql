...
-- for organization table its diff because i am creating the organization record when the user signs up
...
create policy "Account members can delete Organization" on "public"."Organization" for delete to authenticated using (auth.uid () IS NOT NULL);